...
const SCORING_SYSTEM = [
  // Tribal Council
  { category: "Tribal Council", event: "Voted correctly (pre-Merge)",           pts: 2,   icon: "🗳️" },
  ...
  { category: "Tribal Council", event: "Voted incorrectly (Merge)",              pts: -2,  icon: "❌" },
  ...
  { category: "Advantages", event: "Played fake idol or advantage",              pts: 2,   icon: "🎭" },
  ...
  { category: "Endgame", event: "Final Immunity win",                            pts: 10,  icon: "🏛️" },
